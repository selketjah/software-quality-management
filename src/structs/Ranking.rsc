...
alias Metrics = tuple[int volume, set[CompilationUnitMetric] compilationUnitMetrics, tuple[ComponentLOC compilationUnitSizeRel, ComponentLOC methodHolderSizeRel, ComponentLOC methodSizeRel] locByType, Percentages percentages];
